...
void SteeringReverseState::execute(Steering* steering)
{
	Serial.print("DRIVE");
        ...
        //left
        analogWrite(steering->mLeftWheelSpeedPin,steering->mLeftWheelSpeed);
        digitalWrite(steering->mLeftWheelDrivePin,LOW);
        digitalWrite(steering->mLeftWheelReversePin,HIGH);

        //right
        analogWrite(steering->mRightWheelSpeedPin,steering->mRightWheelSpeed);
        digitalWrite(steering->mRightWheelDrivePin,LOW);
        digitalWrite(steering->mRightWheelReversePin,HIGH);
