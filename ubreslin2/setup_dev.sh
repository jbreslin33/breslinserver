...
echo ---------------------------------------------
echo sudo cp /home/$1/sandbox/breslinserver/ubreslin2/apache2.conf /etc/apache2
echo skip next one
echo sudo cp /home/$1/sandbox/breslinserver/ubreslin2/php5.conf /etc/apache2/mods-enabled
sudo cp /home/$1/sandbox/breslinserver/ubreslin2/default /etc/apache2/sites-available
